...
export default function NavBar() {
    ...
    return (
        <nav className="contenedor-NavBar">
            <Link to='/'> <img src={Logo} onClick={()=> history('/')} alt="img not found" width='120px' className="logo" class="shadow-md shadow-black rounded-md" /></Link>
            <SearchBar />
            {isAuthenticated ?
                            ...
                            <div class="w-32 ml-2">
                                <div className=" flex md:w-auto h-5/6 " >
                                    <div className="w-11/12 flex justify-center items-center">
                                        <img src={!user.picture ? imgDefault: user.picture } alt={imgDefault} onClick={()=> registerUser()} class="h-5/6" />
                                    </div>
