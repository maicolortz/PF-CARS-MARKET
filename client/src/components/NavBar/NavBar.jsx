...
export default function NavBar() {
    return (
        <nav className="contenedor-NavBar">
            ...
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none shadow-md shadow-black font-medium rounded-full text-lg px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-900 dark:focus:ring-blue-800">Inicio</button>
            <SearchBar />
            <div>
