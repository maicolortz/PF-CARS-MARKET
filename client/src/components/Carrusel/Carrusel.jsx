    ...
    return (
        <div className="container mx-auto w-full flex items-center justify-center ml-5">
            <div className="flex items-center justify-center w-full h-full mt-3 mb-5">
                ...
                <CarouselProvider className="lg:block hidden" naturalSlideWidth={60} isIntrinsicHeight={true} totalSlides={6} visibleSlides={3} step={1} infinite={true}>
                                        ...
                                        return (
                                            <Slide index={e.brand} onClick={() => history(`/cars/${e.id}`)} >
                                                <div className="flex flex-shrink-0 relative" >
                                                    <img src={e.image ? e.image : imgDefault} alt="" className="lg:h-48 xl:h-56 2xl:h-64 w-full" />
