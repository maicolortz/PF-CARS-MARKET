                        ...
                        <div className="container mx-auto bg-white mt-10 rounded px-4">
                            <div className="xl:w-ful border-b border-gray-300 py-5">
                                <div className="flex justify-center w-11/12 mx-auto xl:w-full xl:mx-0 items-center">
                                    <p className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800">Completa tu perfil</p>
                                    <div title="Complete todo los campos para tener un mejor perfil" className="ml-2 cursor-pointer  text-black">
                                ...
                                <div className="ml-20 mr-20 w-2/4 pt-8">
                                    <div className="container mx-auto">
                                        <div className={estilos.contenedor_input_y_titulo}>
                                            ...
                                            <input type="text" id="firstName" name="firstName" className={estilos.input} onChange={(e) => handleChange(e)} placeholder="Indicar nombre completo ..." />
                                        ...
                                        <div className={estilos.contenedor_input_y_titulo}>
                                            ...
                                            <input type="text" id="lastName" name="lastName" className={estilos.input} onChange={(e) => handleChange(e)} placeholder="Indicar apellidos ..." />
                                        ...
                                        <div className={estilos.contenedor_input_y_titulo}>
                                            ...
                                            <input type="text" id="mail" name="mail" className={estilos.input} value={user && user.email} placeholder="Indicar dirección de correo electrónico ..." />
                                        </div>
                                        <div className={estilos.contenedor_input_y_titulo}>
                                            <label htmlFor="whatsApp" className={estilos.titulos}>
                                                Teléfono:
                                            </label>
                                            <input type="text" id="whatsApp" name="whatsApp" className={estilos.input} onChange={(e) => handleChange(e)} placeholder="Indicar numero telefónico ..." />
                                            {errors.whatsApp && (<p class="text-red-500 text-lg mt-2">{errors.whatsApp}</p>)}
                                        </div>
                                    </div>
                                </div>
                                {/*-------------------------------------------------------------------- Columna 2 ---------------------------------------------------------------------*/}
                                <div className='lg:mr-20 w-2/4 pt-8 md:items-center sm:items-center'>
                                    <div className="container mx-auto">
                                        ...
                                        <div className={estilos.contenedor_input_y_titulo}>
                                            ...
                                            <textarea type="text" id="address" name="address" className={estilos.input} onChange={(e) => handleChange(e)} placeholder="Indicar su dirección ..." />
